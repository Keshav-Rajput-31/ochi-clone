...
const Footer = () => {
  return (
    ...
    <>
      ...
      <div className='main w-screen h-screen flex py-[2%] px-[2%]'>

        <div className='w-1/2 h-full flex flex-col justify-between ' >

          <div className='text-[10vw] font-[FoundersGrotesk] leading-[.8em] uppercase'>
        ...
        <div className=' h-full w-1/2 flex flex-col justify-between '>
          ...
          <div className='font-[FoundersGrotesk] text-[10vw] uppercase leading-none'>
            <h1>presentation</h1>
          </div>
          ...
          <div className=' w-full flex justify-between'>
            ...
            <div className='w-1/2 '>
                  ...
                  <div>

                    {
                      ['instagram', 'behance', 'facebook', 'linkedin'].map((item, index) => {
                        ...
                        return <div className='text-xl capitalize'>{item}</div>
              ...
              <div className='flex flex-col gap-5 pt-5'>
                ...
                <div>
                  <h1 className='text-xl'>hello@ochi.design</h1>
                </div>
              </div>
            ...
            <div className='w-1/2 flex justify-end items-end pr-10 pb-10' >

              <div className='flex flex-col gap-5'>
                <div className='text-2xl '><h1>M:</h1></div>
          ...
          <div className='w-full flex justify-between'>
            ...
            <div>
              ...
              <h1 className='text-xl text-zinc-400'>&copy; Ochi design 2024. <span className='underline'>Legal Terms</span></h1>
            ...
            <div>
              ...
              <h1 className='text-xl text-zinc-400'>Website by Obye</h1>
